...
const Categories = () => (
  ...
  <>
    ...
    <div className="entry-header">                        
      <div className="mb-5">
        ...
        <div className="entry-meta align-items-center">
          <a className="author-avatar" href="#"><img src="/static/images/author-avata-2.jpg" alt /></a>
    ...
    <figure className="image zoom mb-5">
      <Image src="/static/images/thumb/thumb-1240x700.jpg" layout="responsive" alt="true" width={1111} height={626}  />
    </figure> 
      ...
      <div className="box box-author m_b_2rem">
        <div className="post-author row-flex">
          <div className="author-img">
            <img alt="author avatar" src="/static/images/author-avata-1.jpg" className="avatar" />
          </div>
